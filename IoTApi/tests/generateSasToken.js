...
/**
 * Test for /generateSasToken
 */
Test('/generateSasToken', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test generateSasToken post operation', function (t) {
            Mockgen().requests({
                ...
                t.ok(mock);
                t.ok(mock.request);
                //Post the resolved path from mock request
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/generateSasToken']['post']['responses']['200']['schema']);
