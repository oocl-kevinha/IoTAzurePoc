...
/**
 * Test for /IoTEvents/{deviceId}
 */
Test('/IoTEvents/{deviceId}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200
         */
        t.test('test iotEvents get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/IoTEvents/{deviceId}']['get']['responses']['200']['schema']);
